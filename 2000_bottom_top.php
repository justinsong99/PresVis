<head>
  <title>Show Bottom 80% and Top 20%</title>
</head>
<body>
  ...
  if (!$db) {
    ...
    if(!isset($num) || trim($num) == ''){
      ...
      $result = $db->multi_query("SELECT Year,Lowest_fifth+Second_Fifth+Third_Fifth+Fourth_Fifth as 80thPercentileandBelow, Highest_Fifth as Top20Percent FROM IncomeDist WHERE Year>=$num");
      ...
      if (!$result) {
        ...
        if ($result = $db->store_result()) {
          ...
          if (strcmp($columns[0], "ERROR") == 0) {
            ...
            echo "<table border=1>\n";
            echo "<tr><td>Year</td><td>80%</td><td>20%</td></tr>\n";
