...
<body>
  ...
  if (!$db) {
    ...
    $result = $db->multi_query("SELECT * FROM CrimeAndUERates WHERE CrimeAndUERates.ViolentCrimeIncidentRate=(SELECT max(ViolentCrimeIncidentRate) FROM CrimeAndUERates)");
