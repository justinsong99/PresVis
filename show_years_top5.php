...
if (!$db) {
 ...
 $result = $db->multi_query("SELECT Year, Top_5Percent as PercentageOwnedByWealthiest5Percent FROM IncomeDist ORDER BY Top_5Percent DESC LIMIT 10");
